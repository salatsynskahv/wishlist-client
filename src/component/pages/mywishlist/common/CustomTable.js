...
const WishlistTable = ({currentWishlistIndex}) => {
    ...
    const handleInputTableChange = (rowIndex, columnIndex, field, e) => {
        ...
        store.dispatch(updateValueInCurrentWishlist({
            newValue, currentWishlistIndex, index: rowIndex, field
        }));
    ...
    const handleFieldNameChange = (columnIndex, e) => {
        store.dispatch(updateFieldNameInCurrentWishlist({
            newValue: e.target.value, currentWishlistIndex, columnIndex
        }));
        setNeedTableSave(true);
    }
    ...
    const addTableColumn = (e) => {
        ...
        store.dispatch(addColumnAfterInCurrentWishlist({
            currentWishlistIndex, columnIndex: currentFocusValue, columnName: newColumnNameInputRef.current.value
        }));
        setNeedTableSave(true);
    ...
    const threeDotedMenu = (rowIndex) => {
        return (<div className="btn-group dropend">
                <button type="button" className="btn dropdown-toggle three-dot-button"
    ...
    const tableHeader = (wishlist) => {
        return (// <span className="wl-row">
            <>
                {wishlist.fields.map((field, index) => <th key={field.id}>
                    <Editable
                        html={field.name}
    ...
    return (wishlist && <>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="copy-link-container">
                                ...
                                </button> : (<span className="copied-link">Copied!</span>)}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div onMouseLeave={handleUpdateAndSave}>
